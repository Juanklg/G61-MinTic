print(f"Para el registro se solictan los siguientes datos")
...
try:    
    ...
    if rolAdmin=="True" or rolAdmin=="False":
        ...
        #Si elo usuario no digito True o False se cierra la app y se indica q la inicie de nuevo
        print("El valor ingresado en el rol Administrador debe ser False o True")
...
#si lanza algun error retorna el bloque de codigo despues del except
    ...
    print("Alguno de los valore ingresados no es correcto")
    print("vuelva a correr la aplicacion")
